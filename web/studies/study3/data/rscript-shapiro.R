...
paste("Acc_neighbor_one_step_nodesize5 ," , result$Acc_neighbor_one_step_nodesize5$p.value)
paste("Acc_neighbor_one_step_nodesize10 ," , result$Acc_neighbor_one_step_nodesize10$p.value)
"*********************"
...
result=lapply(combineddata, shapiro.test)
paste("Time_neighbor_one_step_nodesize5 ," , result$Time_neighbor_one_step_nodesize5$p.value)
paste("Time_neighbor_one_step_nodesize10 ," , result$Time_neighbor_one_step_nodesize10$p.value)
"*********************"
sink()
