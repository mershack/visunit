...
combineddata =data.frame(Acc_neighbor_one_step_nodesize5, Acc_neighbor_one_step_nodesize10)
combineddata = stack(combineddata)
results = wilcox.test(values~ind, combineddata, paired=TRUE)
tasknames[1] = "Acc_neighbor_one_step_nodesize5-Acc_neighbor_one_step_nodesize10"
...
combineddata =data.frame(Time_neighbor_one_step_nodesize5, Time_neighbor_one_step_nodesize10)
combineddata = stack(combineddata)
results = wilcox.test(values~ind, combineddata, paired=TRUE)
tasknames[1] = "Time_neighbor_one_step_nodesize5-Time_neighbor_one_step_nodesize10"
pvalues[1] = results$p.value
pvalues_adj = p.adjust(pvalues, "bonferroni")
paste(tasknames[1] , "," , pvalues_adj[1])
sink()
