...
results<-capture.output(t.test(Acc_neighbor_one_step_edgesize2,Acc_neighbor_one_step_edgesize4, paired=TRUE))
cat(results, sep="\n")
...
results<-capture.output(t.test(Time_neighbor_one_step_edgesize2,Time_neighbor_one_step_edgesize4, paired=TRUE))
cat(results, sep="\n")
sink()
