...
paste("Acc_neighbor_one_step_arrow ," , result$Acc_neighbor_one_step_arrow$p.value)
paste("Acc_neighbor_one_step_tapered ," , result$Acc_neighbor_one_step_tapered$p.value)
paste("Acc_neighbor_one_step_circular ," , result$Acc_neighbor_one_step_circular$p.value)
"*********************"
...
result=lapply(combineddata, shapiro.test)
paste("Acc_neighbor_two_step_arrow ," , result$Acc_neighbor_two_step_arrow$p.value)
paste("Acc_neighbor_two_step_tapered ," , result$Acc_neighbor_two_step_tapered$p.value)
paste("Acc_neighbor_two_step_circular ," , result$Acc_neighbor_two_step_circular$p.value)
"*********************"
...
result=lapply(combineddata, shapiro.test)
paste("Time_neighbor_one_step_arrow ," , result$Time_neighbor_one_step_arrow$p.value)
paste("Time_neighbor_one_step_tapered ," , result$Time_neighbor_one_step_tapered$p.value)
paste("Time_neighbor_one_step_circular ," , result$Time_neighbor_one_step_circular$p.value)
"*********************"
...
result=lapply(combineddata, shapiro.test)
paste("Time_neighbor_two_step_arrow ," , result$Time_neighbor_two_step_arrow$p.value)
paste("Time_neighbor_two_step_tapered ," , result$Time_neighbor_two_step_tapered$p.value)
paste("Time_neighbor_two_step_circular ," , result$Time_neighbor_two_step_circular$p.value)
"*********************"
sink()
